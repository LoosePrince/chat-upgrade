...
public final class VideoControlClickEvent {
    public static final Identifier ID = Identifier.fromNamespaceAndPath(ChatUpgrade.MOD_ID, "video_control");

    public enum Action { TOGGLE, SEEK }

    public record Parsed(Action action, String url, double ratio) {}

    private VideoControlClickEvent() {}
