...
public final class ChatSurfaceRenderer {
    ...
    public static void paintPanel(GuiGraphicsExtractor graphics, Font font, ChatSurfaceFrame frame) {
        ...
        ChatThemeTokens.Surface tokens = frame.theme().tokens().surface();
        ...
        graphics.outline(panel.left(), panel.top(), panel.width(), panel.height(), tokens.panelBorder());
        graphics.text(
                font,
    ...
    private static void paintClosedRestrictedHud(
            ...
            ChatThemeTokens.Surface tokens) {
