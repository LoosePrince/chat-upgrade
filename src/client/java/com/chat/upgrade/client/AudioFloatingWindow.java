...
public final class AudioFloatingWindow {
    ...
    public static void render(GuiGraphicsExtractor gfx, Font font, int screenWidth, int screenHeight) {
        ...
        paintButton(gfx, font, rects.playL, rects.top, rects.playR, rects.bottom, playing ? "⏸" : "▶", true);
        paintButton(gfx, font, rects.loopL, rects.top, rects.loopR, rects.bottom, loop ? "🔁" : "↺", loop);
        paintButton(gfx, font, rects.openL, rects.top, rects.openR, rects.bottom, "↗", false);
        paintButton(gfx, font, rects.removeL, rects.top, rects.removeR, rects.bottom, "×", false);
